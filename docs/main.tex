...
\begin{figure*}[t]
    \centering
    \subfloat[Average]{\includegraphics[width=0.48\textwidth]{figures/convergence_average_6nodes.pdf}}\hfill
    \subfloat[Sum]{\includegraphics[width=0.48\textwidth]{figures/convergence_sum_6nodes.pdf}}\\
    \subfloat[Min]{\includegraphics[width=0.48\textwidth]{figures/convergence_min_6nodes.pdf}}\hfill
    \subfloat[Max]{\includegraphics[width=0.48\textwidth]{figures/convergence_max_6nodes.pdf}}
...
Le evidenze non vengono fuse in un unico benchmark. In particolare, la sequenza illustrativa $60\rightarrow50\rightarrow40\rightarrow50\rightarrow60$, ottenibile escludendo e reintegrando nell'ordine i contributi 110 e 90, descrive la semantica attesa della media sui soli nodi \texttt{alive}; non è presentata come una misura end-to-end del Compose a sei nodi.
...
In una delle esecuzioni locali registrate per \emph{average}, la baseline senza Traffic Control raggiungeva il criterio della pipeline a circa \AvgConvTime~s. Tale misura appartiene ai grafici baseline, privi di delay artificiale. Nella run separata con NetEm, tutti i nodi sono stati osservati simultaneamente sul valore corretto per la prima volta a circa \TCLocalFirstConv~s e il monitor ha terminato con un nuovo controllo simultaneamente positivo a \TCLocalStable~s.
